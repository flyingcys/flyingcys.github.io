...
const pt = {
    ...
    // Traduções de páginas comuns
    // Página raiz
    page_title: "Caixa de ferramentas flyingcys",
    page_subtitle: "Coleção de ferramentas online práticas para desenvolvedores",
    
    // Lista de ferramentas
    tools_title: "Lista de ferramentas",
    tool_tuyaopen: "TuyaOpen",
    tool_tuyaopen_desc: "Ferramenta de flash de firmware ESP32",
    tool_json: "JSON",
    tool_json_desc: "Ferramenta de formatação e validação JSON",
    tool_xml: "XML",
    tool_xml_desc: "Ferramenta de formatação e validação XML",
    tool_mp3: "Conversão MP3",
    tool_mp3_desc: "Conversor MP3 para array C",
    tool_protobuf: "Protobuf",
    tool_protobuf_desc: "Ferramenta de visualização Protocol Buffers",
    
    // Botões e operações comuns
    btn_open: "Abrir",
    btn_close: "Fechar",
    btn_save: "Salvar",
    btn_cancel: "Cancelar",
