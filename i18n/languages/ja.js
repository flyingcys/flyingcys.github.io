...
const ja = {
    ...
    // 根页面 
    home_title: "開発者ツール集合",
    home_subtitle: "シリアルデバッグ、JSON処理、XML変換、音声処理などの実用的な開発ツールを提供",
    home_footer: "ワンストップ開発ツールプラットフォーム",
    page_title: "flyingcys のツールボックス",
    page_subtitle: "開発者向けの便利なオンラインツール集",
    
    // 工具列表
    tools_title: "ツール一覧",
    tool_tuyaopen: "TuyaOpen",
    tool_tuyaopen_desc: "ESP32 ファームウェア書き込みツール",
    tool_json: "JSON",
    tool_json_desc: "JSON フォーマット・検証ツール",
    tool_xml: "XML",
    tool_xml_desc: "XML フォーマット・検証ツール",
    tool_mp3: "MP3変換",
    tool_mp3_desc: "MP3 to C配列コンバーター",
    tool_protobuf: "Protobuf",
    tool_protobuf_desc: "Protocol Buffers 視覚化ツール",
    ...
    error_permission_denied: "アクセス権限がありません",
    error_unknown: "不明なエラー",
    
    // ========== デュアルモード言語切替器テストページ ==========
    test_page_title: "デュアルモード言語切替器テストページ",
    
    // Debug page specific
    debug_page_title: "🔧 デュアルモード言語切替器デバッグページ",
    debug_page_desc: "このページはデュアルモード言語切替器の問題を診断するために使用されます。以下の項目を順番に確認してください：",
    test_title: "テストタイトル（日本語）",
    test_content: "これは言語切り替えが正常に動作するかを検証するためのテストコンテンツです。現在表示中：日本語版。",
    test_button: "テストボタン（日本語）",
    test_placeholder: "日本語テスト内容を入力してください",
    basic_function_test: "基本機能テスト",
    ...
    feature_showcase: "機能紹介",
    auto_mode_title: "自動モード",
    auto_mode_desc: "ブラウザ言語に基づいて自動検出・切替、地域言語マッピングをサポート",
    auto_feature_1: "ブラウザ言語の自動検出",
    auto_feature_2: "スマート言語マッピング",
    auto_feature_3: "初回訪問時の自動設定",
    
    manual_mode_title: "手動モード",
    manual_mode_desc: "ユーザーが言語選択を完全制御、設定は永続的に保存",
    manual_feature_1: "ユーザーの完全制御",
    manual_feature_2: "設定の永続保存",
    manual_feature_3: "ブラウザ言語の影響を受けない",
    
    smart_features_title: "スマート機能",
    smart_features_desc: "複数の高度な機能で最高のユーザー体験を確保",
    smart_feature_1: "URLパラメータサポート",
    smart_feature_2: "エラーフォールバック機構",
    smart_feature_3: "パス自動適応",
    
    ui_features_title: "UI機能",
    ui_features_desc: "美しくモダンなインターフェースデザインとインタラクティブ体験",
    ui_feature_1: "デュアルボタンデザイン",
    ui_feature_2: "モードインジケーター",
    ui_feature_3: "レスポンシブデザイン",
    
    test_controls: "テスト制御",
    test_switch_en: "英語に切替",
    test_switch_ja: "日本語に切替",
    test_switch_zh: "中国語に切替",
    test_auto_mode: "自動モードをテスト",
    test_manual_mode: "手動モードをテスト",
    check_status: "ステータス確認",
    
    real_time_status: "リアルタイムステータス",
    detection_mode: "検出モード",
    selected_language: "選択された言語",
    mode_tip: "(自動モードはブラウザ言語を検出)",
    language_tip: "(現在表示されている言語)",
    
    test_elements: "テスト要素",
    text_content: "テキストコンテンツ",
    button_text: "ボタンテキスト",
    input_placeholder: "入力プレースホルダー",
    sample_text: "これはサンプルテキストです",
    sample_button: "サンプルボタン",
    sample_placeholder: "内容を入力してください",
