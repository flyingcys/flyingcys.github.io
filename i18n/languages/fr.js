...
const fr = {
    ...
    support_desc: "Si vous rencontrez des problèmes lors de l'utilisation, obtenez de l'aide par les moyens suivants :",
    github_support: "Soumettre un rapport de problème",
    
    // Traductions de pages communes
    // Page racine
    page_title: "Boîte à outils flyingcys",
    page_subtitle: "Collection d'outils en ligne pratiques pour les développeurs",
    
    // Liste des outils
    tools_title: "Liste des outils",
    tool_tuyaopen: "TuyaOpen",
    tool_tuyaopen_desc: "Outil de flash de firmware ESP32",
    tool_json: "JSON",
    tool_json_desc: "Outil de formatage et validation JSON",
    tool_xml: "XML",
    tool_xml_desc: "Outil de formatage et validation XML",
    tool_mp3: "Conversion MP3",
    tool_mp3_desc: "Convertisseur MP3 vers tableau C",
    tool_protobuf: "Protobuf",
    tool_protobuf_desc: "Outil de visualisation Protocol Buffers",
    
    // Boutons et opérations communes
    btn_open: "Ouvrir",
    btn_close: "Fermer",
    ...
    // Informations d'erreur communes
