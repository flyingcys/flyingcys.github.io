...
const zh = {
    ...
    flashdownloader_reset_baudrate: "FlashDownloader: 重置串口波特率到115200...",
    flashdownloader_baudrate_reset_success: "FlashDownloader: ✅ 串口波特率已重置到115200",
    flashdownloader_direct_reset_success: "FlashDownloader: ✅ 串口已直接重置到115200",
    flashdownloader_reset_failed: "FlashDownloader: 重置串口波特率失败",
    flashdownloader_direct_reset_failed: "FlashDownloader: 直接重置串口也失败"
};
