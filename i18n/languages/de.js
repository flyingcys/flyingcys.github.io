...
const de = {
    ...
    // Werkzeugliste
    tools_title: "Werkzeugliste",
    tool_tuyaopen: "TuyaOpen",
    tool_tuyaopen_desc: "ESP32 Firmware-Flash-Tool",
    tool_json: "JSON",
    tool_json_desc: "JSON-Format- und Validierungstool",
    tool_xml: "XML",
    tool_xml_desc: "XML-Format- und Validierungstool",
    tool_mp3: "MP3-Konvertierung",
    tool_mp3_desc: "Audio-Dateiformat-Konvertierungstool",
    tool_protobuf: "Protobuf",
    tool_protobuf_desc: "Protocol Buffers Analyse-Tool",
    
    // Allgemeine Schaltflächen und Operationen
    btn_open: "Öffnen",
    btn_close: "Schließen",
    btn_save: "Speichern",
