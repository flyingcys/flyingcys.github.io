...
const ru = {
    ...
    support_desc: "Если у вас возникли проблемы при использовании, получите помощь следующими способами:",
    github_support: "Отправить отчет о проблеме",
    
    // Переводы общих страниц
    // Корневая страница
    page_title: "Набор инструментов flyingcys",
    page_subtitle: "Коллекция практичных онлайн-инструментов для разработчиков",
    
    // Список инструментов
    tools_title: "Список инструментов",
    tool_tuyaopen: "TuyaOpen",
    tool_tuyaopen_desc: "Инструмент прошивки ESP32",
    tool_json: "JSON",
    tool_json_desc: "Инструмент форматирования и валидации JSON",
    tool_xml: "XML",
    tool_xml_desc: "Инструмент форматирования и валидации XML",
    tool_mp3: "Конвертация MP3",
    tool_mp3_desc: "Конвертер MP3 в массив C",
    tool_protobuf: "Protobuf",
    tool_protobuf_desc: "Инструмент визуализации Protocol Buffers",
    
    // Общие кнопки и операции
    btn_open: "Открыть",
    btn_close: "Закрыть",
    btn_save: "Сохранить",
    btn_cancel: "Отмена",
