...
const ko = {
    ...
    // 통용 페이지 번역
    // 루트 페이지
    page_title: "flyingcys 도구상자",
    page_subtitle: "개발자를 위한 편리한 온라인 도구 모음",
    
    // 도구 목록
    tools_title: "도구 목록",
    tool_tuyaopen: "TuyaOpen",
    tool_tuyaopen_desc: "ESP32 펌웨어 플래시 도구",
    tool_json: "JSON",
    tool_json_desc: "JSON 포맷 및 검증 도구",
    tool_xml: "XML",
    tool_xml_desc: "XML 포맷 및 검증 도구",
    tool_mp3: "MP3 변환",
    tool_mp3_desc: "MP3를 C 배열로 변환하는 도구",
    tool_protobuf: "Protobuf",
    tool_protobuf_desc: "Protocol Buffers 시각화 도구",
