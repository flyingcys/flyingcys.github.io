...
"""
    ...
    h_file = os.path.join(directory, "../include/media_src.h")
...
def convert_mp3_to_c(directory):
    ...
    for suffix in ["zh", "en"]:
        if mp3_files[suffix]:
            ...
            h_file = os.path.join(directory, f"../include/media_src_{suffix}.h")
            c_file = os.path.join(directory, f"../src/media_src_{suffix}.c")
